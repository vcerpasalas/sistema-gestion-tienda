    ...
    public static class ProductoVendidoData
    {
        ...
        public static List<ProductoVendido> ObtenerProductosVendidosPorVenta(int idVenta)
        {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    SqlCommand command = new SqlCommand("SELECT * FROM ProductoVendido WHERE IdVenta = @IdVenta", connection);
        ...
        public static void CargarProductos(Producto producto, int stock, int correlativoProductoVendido, int idVenta)
        {
            try
            {
                ...
                {
                    connection.Open();
                    SqlCommand command = new SqlCommand("INSERT INTO ProductoVendido (Id, IdProducto, Stock, IdVenta) values (@Id, @IdProducto,@Stock, @IdVenta)", connection);
